...
EXTRA_MODULES = utils.js convenience.js windowListener.js windowManager.js tray.js icons
TOLOCALIZE =
...
./schemas/gschemas.compiled: ./schemas/org.gnome.shell.extensions.minimize-to-tray.gschema.xml
